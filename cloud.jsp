...
<div id="header">
	...
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="cloud.jsp" accesskey="2" title="">Cloud</a></li>
...
<div id="footer-wrapper">
	<div id="footer-content">
		<h2 style="font-family:'Oswald', sans-serif;font-size: 35px;text-transform: uppercase;	font-weight:bold;color:black;text-align: center;">CLOUD LOGIN</h2>
		<div id="fbox1">
		...
		<div id="fbox2" style="border:5px solid black;border-radius:10px;">
			<form name="s" action="cloudlogin.jsp" method="get" onSubmit="return valid()" >          
