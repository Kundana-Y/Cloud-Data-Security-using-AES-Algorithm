...
<div id="header">
	...
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="admin.jsp" accesskey="3" title="">Admin</a></li>
			<li><a href="cloud.jsp" accesskey="2" title="">Cloud</a></li>
			<li><a href="owner.jsp" accesskey="2" title="">Data Owner</a></li>
			<li><a href="user.jsp" accesskey="2" title="">Data User</a></li>			
		</ul>
	</div>
</div>
<div id="banner-wrapper">
	<div id="banner" style="border:5px solid black;"><img src="images/10_cloud_manage.jpg" width="1000" height="245" alt="" /></div>
</div>
<div id="page-wrapper">
...
<div id="footer-wrapper">
	<div id="footer-content">
		<h2 style="font-family:'Oswald', sans-serif;font-size: 35px;text-transform: uppercase;	font-weight:bold;color:black;text-align: center;">ADMIN LOGIN</h2>
		<div id="fbox1">
			<p><img src="images/admin1.png" width="250" height="250" alt="" style="margin-left:50px;margin-top:30px;"/></p>
			
		</div>
		<div id="fbox2" style="border:5px solid black;border-radius:10px;">
			<form name="s" action="adminlogin.jsp" method="get" onSubmit="return valid()" >          
